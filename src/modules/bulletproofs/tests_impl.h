...
void test_bulletproof_inner_product(size_t n, const secp256k1_bulletproof_generators *gens) {
    ...
    secp256k1_scratch_space *scratch = secp256k1_scratch_space_create(CTX, 100000 + 256 * (2 * n + 2));
...
void test_bulletproof_rangeproof(size_t nbits, size_t expected_size, const secp256k1_bulletproof_generators *gens) {
    ...
    secp256k1_pedersen_ecmult(&CTX->ecmult_gen_ctx, &commitj, &blind, v, &value_gen[0]);
    secp256k1_ge_set_gej(&commitp, &commitj);
    secp256k1_pedersen_ecmult(&CTX->ecmult_gen_ctx, &commitj, &blind, v, &value_gen[2]);
...
void test_bulletproof_rangeproof_aggregate(size_t nbits, size_t n_commits, size_t expected_size, const secp256k1_bulletproof_generators *gens) {
    ...
    for (i = 0; i < n_commits; i++) {
        ...
        secp256k1_pedersen_ecmult(&CTX->ecmult_gen_ctx, &commitj, &blind[i], v[i], &value_gen);
...
void run_bulletproofs_tests(void) {
    ...
    secp256k1_bulletproof_generators *gens = secp256k1_bulletproof_generators_create(CTX, secp256k1_generator_const_g, 32768);
