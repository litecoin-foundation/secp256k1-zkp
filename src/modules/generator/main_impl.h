...
/** The standard secp256k1 base generator G, exposed as a secp256k1_generator
 *  so callers can use it as a typed parameter (e.g. as the blinding generator
 *  of a Bulletproof generator table). Hard-coded x and y; canonical source is
 *  SECP256K1_G in src/group_impl.h.
 */
static const secp256k1_generator secp256k1_generator_g_internal = {{
...
const secp256k1_generator *secp256k1_generator_g = &secp256k1_generator_g_internal;
