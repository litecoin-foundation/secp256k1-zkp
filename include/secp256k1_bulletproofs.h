...
/* Upstream secp256k1-zkp exposes the static generators as
 * secp256k1_generator_const_{g,h}; libwally consistently drops the _const
 * infix. Provide aliases so verbatim-vendored bulletproof code that
 * references the upstream names continues to resolve. */
# define secp256k1_generator_const_g secp256k1_generator_g
# define secp256k1_generator_const_h secp256k1_generator_h
