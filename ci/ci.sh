...
print_environment() {
    ...
    for var in WERROR_CFLAGS MAKEFLAGS BUILD \
            ...
            ECDSA_S2C GENERATOR RANGEPROOF BULLETPROOF WHITELIST MUSIG ECDSAADAPTOR BPPP \
...
./configure \
    ...
    --enable-module-rangeproof="$RANGEPROOF" --enable-module-bulletproof="$BULLETPROOF" --enable-module-whitelist="$WHITELIST" --enable-module-generator="$GENERATOR" \
